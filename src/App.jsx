...
export default function MusicApp() {
  ...
  const proxyUrl = `http://localhost:8000/api/proxy?url=${encodeURIComponent(apiUrl)}`;
  const proxyUrlT = `http://localhost:8000/api/proxy?url=${encodeURIComponent(apiUrlT)}`;
